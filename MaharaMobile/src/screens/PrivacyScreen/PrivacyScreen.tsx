    ...
    <List>
        ...
        <Body>
          ...
          <MediumText
            text={t`We are committed to protecting your privacy and providing
              you with a safe and functional personal learning and development
              environment. This Statement of Privacy applies to the mobile app
              'Mahara Mobile' as provided by Catalyst IT on behalf of the
      ...
      <ListItem>
        <Body>
          ...
          <MediumText
            text={t`Neither the Mahara project nor Catalyst have access to any
              of the data that you enter on Mahara Mobile. The institution that
              hosts the Mahara site that you connect to cannot access data in
              your Mahara Mobile app either.`}
          />
        </Body>
      </ListItem>
        ...
        <Body>
          ...
          <MediumText
            text={t`We will take all reasonable steps to ensure that the
              ...
              information is not disclosed. Neither the Mahara project nor  Catalyst IT are responsible though for maintaining the Mahara
              ...
              of the organization providing the Mahara service to keep the site
              and its content secure. In order to help protect your personal
              information, please do not disclose your username or password to
              anybody or allow them to view content you are planning to upload
              to your Mahara site via Mahara Mobile. Once content has been
              uploaded, file names, descriptions, and journal entries are not
              available via the app anymore. Images and videos will still be
              stored in their original location on your device. Audio
              recordings are not stored outside of Mahara Mobile.`}
          />
        </Body>
      </ListItem>
        ...
        <Body>
          ...
          <MediumText
            text={t`We may occasionally make adjustments to our Privacy
              ...
              feedback. As such we suggest you check the Privacy Statement each
              time you visit this app.`}
          />
        </Body>
      </ListItem>
      ...
      <ListItem>
        <Body>
          ...
          <MediumText>
            <MediumText
              text={t`If you have any questions regarding this Statement or
                believe we have not adhered to the above criteria, please`}
            />
            <LinkText
