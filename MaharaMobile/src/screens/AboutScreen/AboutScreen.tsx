    ...
    <ScrollView style={generic.wrap}>
      <VStack space={3} divider={<Divider />} w="90%">
        ...
        <HStack>
          <MediumText>
            <Trans>
              ...
              Mahara site. You can create and collect your content on your
              mobile device and use the app to upload it to your Mahara site.
              You can upload any files that your device allows you to upload and
        ...
        <HStack>
          <MediumText>
            <Trans>
              Mahara is an open source ePortfolio platform designed for
              ...
              You can also engage in conversations with others and create group
              portfolios.
            </Trans>
          </MediumText>
        </HStack>
        <HStack>
          <MediumText>
            <Trans>
              ...
              device, including when you are offline. You can then upload your
              photos, videos, journal entries, etc. to your Mahara instance and
              add them your portfolios.
              <MediumText>
                <Trans />
              </MediumText>
            </Trans>
        ...
        <HStack>
          <MediumText>
            <Trans>
              ...
              site available to you to use if you are working with portfolios.
            </Trans>
          </MediumText>
        </HStack>
      </VStack>
