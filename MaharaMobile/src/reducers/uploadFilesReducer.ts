...
import { ADD_UPLOAD_FILE, REMOVE_UPLOAD_FILE, CLEAR_UPLOAD_FILES, UPDATE_UPLOAD_FILES_ON_LOGIN } from '../utils/constants';
...
// Helper functions
const getFiles = (ids: string[], arr: Record<string, MaharaPendingFile>) => ids.map((id: string) => arr[id]);
