    ...
    <VStack space={3} divider={<Divider />} w="90%">
      <HStack>
        <Box>
          ...
          />
          <MediumText
            text="We are committed to protecting your privacy and providing
          ...
          />
          <MediumText
            text="By using the full potential of the application, you will
          ...
          />
          <MediumText
            text="Your own name is displayed in the app once you are logged
      ...
      <HStack>
        <Box>
          <SubHeading
            ...
            //  text={t`How we use your personal information`}
          />
          <MediumText
            text="Neither the Mahara project nor Catalyst IT have access to
      ...
      <HStack>
        <Box>
          <SubHeading
            text="Storage and security of your personal
            information"
            //   text={t`Storage and security of your personal
            //   information`}
          />
          <MediumText
            text="We will take all reasonable steps to ensure that the
      ...
      <HStack>
        <Box>
          <SubHeading
            ...
            // text={t`Deleting your data`}
          />
          <MediumText
            text="Once you have uploaded data to your Mahara account, it is no longer stored in the app.
      ...
      <HStack>
        <Box>
          <SubHeading
            ...
            // text={t`Changes to this Privacy Statement`}
          />
          <MediumText
            text="We may occasionally make adjustments to our Privacy
